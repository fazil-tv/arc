  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto py-20 px-4 md:px-8 lg:px-10">
        ...
        The project consists of key phases: initiation, planning, execution, monitoring, and closure. Each phase is essential for effective management, facilitating collaboration and ensuring timely completion of deliverables while aligning with our overall objectives.
        </p>
      </div>
          ...
          >
            <div className="sticky flex flex-col md:flex-row z-40 items-center top-40 self-start max-w-xs lg:max-w-sm md:w-full">
              <div className="h-10 absolute left-3 md:left-3 w-10 rounded-full bg-white dark:bg-black flex items-center justify-center">
                <div className="h-4 w-4 rounded-full bg-green-300 dark:bg-neutral-800 border border-neutral-300 dark:border-neutral-700 p-2" />
              </div>
